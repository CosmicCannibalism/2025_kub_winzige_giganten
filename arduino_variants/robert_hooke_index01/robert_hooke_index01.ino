...
//
// Video duration: 149.837 seconds
// Relay timing: 500ms delay + 149337ms duration (149.837s total)
//
...
const unsigned long relayDuration = 149337; // Relay open duration for Robert Hooke video (149.837s - 500ms)
